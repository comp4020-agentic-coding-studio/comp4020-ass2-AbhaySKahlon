...
export const courseMeta = slopCourseMetaSchema.parse({
  ...
  endDate: "2027-05-28",
  description:
    "A twelve-week investigation into why waiting feels different from the " +
    "time that passes, and how people, systems and designers shape the " +
    "difference.",
  tags: ["waiting", "service design", "time perception"],

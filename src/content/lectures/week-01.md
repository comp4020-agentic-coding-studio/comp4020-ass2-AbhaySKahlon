...
title: Five Minutes
description:
  Why the same five minutes on a clock can feel like nothing or like
  forever — and the two different ways people end up judging how long a wait
  took.
week: 1
date: 2027-02-22
tags:
...
Five minutes standing in a queue with nothing to look at, five minutes on
hold with music, and five minutes waiting for a friend who is already
visible down the street — a stopwatch would call all three identical. Ask
the person doing the waiting, and they won't.
...
Keep two different quantities apart from the start:
...
There's a second distinction underneath the first, and it matters more than
...
Starting this week, you keep a **wait-observation log**: a running personal
record of ordinary waits, each one noting the clock duration alongside your
judged duration, and whether that judgement was prospective or
retrospective. The session for this week sets up the format and has you make
your first entries. Nothing about the log requires special equipment or
access — it runs on waits you'd be having anyway.
